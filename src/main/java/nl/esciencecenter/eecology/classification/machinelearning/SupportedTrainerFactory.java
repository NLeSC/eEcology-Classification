...
public class SupportedTrainerFactory implements TrainerFactory {
    ...
    @Inject
    public SupportedTrainerFactory(@Named("machine_learning_algorithm") String machineLearningAlgorithm,
    ...
    /* (non-Javadoc)
     * @see nl.esciencecenter.eecology.classification.machinelearning.TrainerFactory#getTrainer()
     */
    @Override
