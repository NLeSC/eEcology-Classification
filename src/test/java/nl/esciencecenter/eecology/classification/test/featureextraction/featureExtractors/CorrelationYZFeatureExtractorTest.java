...
public class CorrelationYZFeatureExtractorTest extends FeatureExtractorTest {
    ...
    public void extractFeatures_2SequenceVectors_correctOutput() {
        ...
        // Assert
        assertEquals(test1yzExpected.get(0, 0), output.get(0, 0), errorMargin);
    }
    ...
    public void setUp() throws Exception {
        featureExtractor = new CorrelationYZFeatureExtractor();
    }
}
